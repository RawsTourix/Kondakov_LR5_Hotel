...
**Module:** **[Функции для работы с комнатами](Modules/group__room__operations.md)**
...
**Return**: 
  ...
  * Функция-обработчик изменения комнаты
...
**Return**: 
  ...
  * true если комната существует, иначе false
